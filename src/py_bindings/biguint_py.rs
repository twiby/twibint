...
#[pyclass]
#[derive(Clone)]
pub struct BigUint(pub crate::BigUint<u64>);

impl Deref for BigUint {
    type Target = crate::BigUint<u64>;
    fn deref(&self) -> &crate::BigUint<u64> {
        &self.0
    }
}

impl DerefMut for BigUint {
    fn deref_mut(&mut self) -> &mut crate::BigUint<u64> {
        &mut self.0
    }
}

impl AsRef<crate::BigUint<u64>> for BigUint {
    fn as_ref(&self) -> &crate::BigUint<u64> {
        &self.0
    }
}
...
impl BigUint {
    ...
    pub fn __divmod__(&self, other: &PyAny) -> PyResult<(Self, Self)> {
        let (q, r) =
            crate::BigUint::<u64>::rem_div(self.as_ref(), Self::try_from(other)?.as_ref())?;
        Ok((Self(q), Self(r)))
    }
    ...
    pub fn __rdivmod__(&self, other: &PyAny) -> PyResult<(Self, Self)> {
        let (q, r) =
            crate::BigUint::<u64>::rem_div(Self::try_from(other)?.as_ref(), self.as_ref())?;
        Ok((Self(q), Self(r)))
    }
    ...
    pub fn __pow__(&self, other: usize, modulus: Option<usize>) -> PyResult<Self> {
        if matches!(modulus, Some(_)) {
            ...
            Ok(Self(crate::BigUint::<u64>::pow(self.as_ref(), other)))
        }
    }
    ...
    pub fn __bool__(&self) -> bool {
        self.as_ref() != &crate::BigUint::default()
    }
