...
fn fibonacci_square() {
	...
	assert_eq!(String::from(&n3), "1943883554718163504159639641586\
		...
		3339064759515625");
	assert_eq!(String::from(&n2), "1943883554718163504159639641586\
		529474755957583106913701654561621695450376368896305381\
		612382980919365953591566108064186948023260738153211479\
		434817249275036032824029805681946181926453630633514153\
		3339064759515625");
...
fn factorial_100() {
	...
	assert_eq!(String::from(n), "933262154439441526816992388562667\
